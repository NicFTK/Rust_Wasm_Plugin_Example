...
impl PrettifyHost {
        ...
        PathT: AsRef<path::Path>,
    {
        ...
        Prettify::add_to_linker(&mut linker, |state: &mut Host| state).context("link plugin host")?;
        ...
        // Bindings
        let prettify =
            Prettify::instantiate(&mut store, &component, &linker).context("instantiate bindings")?;
    ...
    /// Prettify.
    pub fn prettify(&mut self, name: &str) -> Result<bindings::local::val::types::Val, anyhow::Error> {
